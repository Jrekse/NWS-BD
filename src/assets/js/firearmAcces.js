const Firearms = [
    ...
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/best-of-the-west-logo.jpg',  
                    ...
                    'email' : 'contact@thebestofthewest.net',
        'content' : 'Best of the West Productions, LLC, producer of the award-winning television series “The Best of the West,” has pioneered long range hunting. Today, BOTW continues to ethically push the boundaries of the long range shooting industry with technological innovations and improved techniques offered all together in our turnkey shooting systems fitted with our own Huskemaw Optics, the only scope line built around the “TrueBC” concept using patented Windage Compensating Technology and Hunt Smart Reticle.'
    },
    {
    ...
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/dead_foot_arms-logo.jpg',  
                    ...
                    'email' : 'info@deadfootarms.com',
        'content' : 'Dead Foot Arms LLC designs, develops, assembles, and markets innovative firearm parts of the highest quality for demanding applications in the commercial, law enforcement, and defense markets. Our core value is to provide innovative cutting edge products to our customers through quality processes and continuous improvement initiatives.Dead Foot Arms LLC is a veteran owned and operated small business. Our products are and always will be proudly made in the U.S.A.'
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/DickinsonArms-logo.jpg',  
                    ...
                    'email' : 'info@dickinsonarms.com',
        'content' : 'Dickinson Arms offers hunters, sport shooters and shotgun enthusiasts a complete line of premium-quality shotguns crafted with meticulous attention to detail in Turkey’s finest factories. The Dickinson family includes side-by-side, over & under, semi-auto, pump and single-shot models. These range from custom guns and hand-engraved side lock and side plate models suitable for serious collectors, to high-performance hunting and sporting guns, to home defense and tactical shotgun models trusted by professionals worldwide.  From top to bottom, the Dickinson line provides shooters with superior performance and exceptional value at every level.'
    },
    {
        'title' : 'DIP, Inc.',
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/DIP-logo.jpg',  
                    ...
                    'email' : 'sales@diproductsinc.com',
        'content' : 'Modern Rimfire Parts Specialists. We specialize in replacing original plastic parts with CNC metal parts. Our products are proudly made in the USA, with USA-made raw materials by highly qualified machinists and shooters.'
    },
    {
    ...
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/gallery_of_guns-logo.jpg',  
                    ...
                    'email' : 'comments@galleryofguns.com',
        'content' : 'SEARCH our website, FIND your gun, and BUY it from your local dealer. It’s just that easy. GalleryofGuns.com allows consumers to buy from a huge selection of firearms from the firearms industry’s top manufacturers. Over and under shotguns, combination guns, varmint rifles, handguns, you name it, GalleryofGuns.com has it.'
    },
    {
    ...
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/KICK_EEZ-logo.jpg',  
                    ...
                    'email' : 'RJ@KICKEEZProducts.com',
        'content' : 'KICK-EEZ® sells a wide selection of rifle recoil pads and shooting supplies made in the United States using Sorbothane®, which provides shock absorption and reduces recoil effectively and quickly. Less recoil reduces flinching, easing sore shoulders and cheeks and eliminates it in all shooting conditions. From shoulder to fingers, KICK-EEZ® has something to help reduce flinching and ease soreness as well as help to adjust your “line of sight.”'
    },
    {
    ...
    },
    {
        ...
        'logo' : 'https://htmlcolorcodes.com/assets/images/colors/light-gray-color-solid-background-1920x1080.png',  
                    ...
                    'email' : 'admin@octobercountry.com',
        'content' : 'October Country Muzzleloading started with a hunting bag made back in 1977. Today in North Idaho, we manufacturer a full line of black powder product for the Muzzleloading industry. Our products also include something for the cowboy action shooters and the black powder cartridge shooters. As a manufacturer, we provide products to the public at retail prices and to dealers at a wholesale price.'
    },
    {
        ...
        'logo' : 'https://htmlcolorcodes.com/assets/images/colors/light-gray-color-solid-background-1920x1080.png',  
                    ...
                    'email' : 'Customer.service@palmettostatearmory.com',
        'content' : '“Since its inception, Palmetto State Armory has focused on providing the best quality AR-15 parts and accessories for the best price possible. Following year after year of exponential growth, Palmetto State Armory’s core principle remains the same, and our commitment to freedom remains unwavering. The idea is simple: MAXIMIZE FREEDOM BY SELLING AS MANY GUNS TO AS MANY LAW-ABIDING AMERICANS AS POSSIBLE!”'
    },
    {
        ...
        'logo' : 'https://htmlcolorcodes.com/assets/images/colors/light-gray-color-solid-background-1920x1080.png',  
                    ...
                    'email' : 'jpierceltd@tds.net',
        'content' : 'Looking for the paramount in lightweight shooting? The Pierce Titanium Action will get the job done. Utilizing high-strength 6AL4V Grade 5 Titanium with a full DLC coating, this offers an unparalleled combination of low weight, high hardness and a low friction coefficient, giving you, the shooter, the ultimate edge of repeatability and accuracy. The Titanium action weights start around 20 ounces and can be as light as 15 ounces in their featherweight option. Also new for 2020 are the 10X and 20X ELR actions, capable of handling Lapua-, Cheytac- and BMG-sized bolt faces. Contact Pierce Engineering about a full custom rifle build, from a championship-winning F-Class rifle to long-range ultralight hunting rifles, “some as low as five pounds overall weight.”'
    },
    {
        'title' : 'PMA Tool',
    ...
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/RSPercisionSports_logo.jpg',  
                    ...
                    'email' : '',
        'content' : 'Providing accessories for various guns from some of the best known manufacturers in the business: Boyds, Volquartsen, Tactical Solutions, Green Mountain, Revolution, Shaw, Pike Arms, Titan, Harris, Athlon, Diproducts, etc. Our goal is customer satisfaction. Customer service is our top priority. Founded in 1996.'
    },
    {
    ...
    },
    {
        ...
        'logo' : 'https://htmlcolorcodes.com/assets/images/colors/light-gray-color-solid-background-1920x1080.png',  
                    ...
                    'email' : '',
        'content' : 'At Stocky’s, our mission is to promote, enhance, and expand the enjoyment of the art and science of accessorizing modern rifles. Our focus is not only on the experienced shooter, but also on keeping it simple enough for the average shooter with a normal amount of experience in the field.'
    },
    {
        ...
        'logo' : 'https://nwsportsmanmag.com/wp-content/uploads/2021/11/tannerite-logo-20th.jpg',  
                    ...
                    'email' : '',
        'content' : 'Tannerite® brand targets were specifically designed to be safe and non-flammable, whether it’s sitting on a shelf, being mixed or used. When shot with a high-power rifle it produces a water vapor and a thunderous boom resembling an explosion. THIS. IS. Tannerite® – not a fake. Imitation is the highest form of flattery – UNFORTUNATELY – our competitors don’t follow the same guidelines for safety and quality. We invented BINARY EXPLODING TARGETS. We know the science. We back our product. If it does NOT say Tannerite® or display our logo, then it is a FAKE! Tannerite® brand targets are the shot indicator targets of choice for hunters, law enforcement, and U.S. armed services. Our company ships product across the United States and around the world. With representation in various retail stores across the US and Canada, you will be able to pick up your target easily! Tannerite® is continually developing new and exciting products. Our goal is to provide firearm enthusiasts a safe, user-friendly shot indicator for target practice using a variety of firearms. Providing unparalleled customer service and product guarantee is, and will always be, at the forefront of our day to day work. Giving back to the community is what is right. We have started new campaigns to donate proceeds to various organizations. For more information, check out our GIVING BACK page.'
    },
    {
        'title' : 'UltiMAK, Inc.',
        'logo' : 'https://htmlcolorcodes.com/assets/images/colors/light-gray-color-solid-background-1920x1080.png',  
                    ...
                    'email' : 'web@ultimak.com',
        'content' : 'Optic (scope) mounting solutions for AK-47 and variants, M1 Garand, M14/M1A, Mini-14, Mini-30 and M1 30 Carbine. Proven, rock solid mounting platforms which are designed for user installation, stable retention of zero, ease of take-down and reassembly of the rifle, without removing the mount or interfering with the receiver mechanism.'
    },
    {
